...
const Card = ({images, title, price, description,slug_name}) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card__content">
          <div className="card__badge">{slug_name}</div>
          ...
          <div className="card__footer">
            ...
            <div className="card__price !text-gray-500 !line-through">${price+100} </div>
            <div className="card__price !text-red-500 ">${price}</div>
            </div>
